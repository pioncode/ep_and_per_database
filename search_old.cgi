...
#Path to CGI
$path_proton5="./";
#$path_server="/var/www/cgi-bin/db/";
...
#Load the Google template into a string, this is in a seperate file
local $/=undef;
open FILE, "/cgi-bin/db/"."google_search.tmpl" or die "Couldn't open file: $!";
binmode FILE;
$gtemplate = <FILE>;
close FILE;
