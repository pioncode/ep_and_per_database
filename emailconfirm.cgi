...
if ($random == $number){
  ...
  print p, "Thank you for registering for the email alerting service.  You will receive an email alert when new papers are added to the <i>$jname{$journal}</i> website, or, in rare cases, when we need to convey important information concerning the journal or website.", p, "Click <a href='$journal.html'>here</a> to go to the journal homepage. <p>If you wish to unsubscribe from the alerting service, please click <a href='unsubscribe.cgi?i=$id&amp;n=$random'>here</a>.";
}
